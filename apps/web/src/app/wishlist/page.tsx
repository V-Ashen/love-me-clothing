...
export default function WishlistPage() {
  ...
  if (authLoading || wishlistLoading || loading) {
    return <div className="text-center py-20 text-gray-400 font-bold">Loading Wishlist...</div>;
  }
  ...
  return (
    <div className="container mx-auto px-4 pt-32 pb-12 max-w-7xl relative">
      ...
      <h1 className="text-4xl font-extrabold text-white mb-2 text-center uppercase tracking-widest font-serif">My Wishlist</h1>
      <p className="text-center text-gray-400 mb-10 text-sm font-medium">Your favorite picks, saved for later.</p>
      ...
      {wishlistProducts.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-gray-400 mb-6">Looks like you haven't saved any items yet.</p>
          <button 
