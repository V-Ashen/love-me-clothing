      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        <div className="relative h-[60vh] lg:h-screen w-full lg:sticky top-0 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-16 lg:bottom-12 z-10 animate-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="space-y-4">
              <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5 flex items-center gap-4 hover:bg-white/15 transition-colors">
            ...
            <div className="flex gap-4 mt-8">
              <a href="https://www.tiktok.com/@love.me.clothing?_t=ZS-97V2vqXXphM" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-accent hover:text-black transition-all hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"/></svg>
              </a>
              <a href="https://www.instagram.com/clothingloveme?igsh=NDAwcXcxNXptcWF4" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-accent hover:text-black transition-all hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="https://www.facebook.com/share/1BKLbhug8n/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-accent hover:text-black transition-all hover:scale-110">
        ...
        <div className="w-full flex items-center justify-center p-8 lg:p-24 relative overflow-hidden bg-[#0a0a0a]">
          ...
          <div className="w-full max-w-xl relative z-10">
            ...
            <p className="text-gray-400 mb-10 font-light">We usually respond within 24 hours.</p>
